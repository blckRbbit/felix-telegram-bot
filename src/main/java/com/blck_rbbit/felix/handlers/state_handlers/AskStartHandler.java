...
@Slf4j
@Component
public class AskStartHandler implements InputMessageHandler {

    private final UserDataCache userDataCache;
    private final ReplyMessagesService messagesService;
    private KeyboardService keyboardService;

    public AskStartHandler(UserDataCache userDataCache, ReplyMessagesService messagesService) {
    ...
    private SendMessage processUsersInput(Message inputMsg) {
        ...
        SendMessage replyToUser = messagesService.getReplyMessage(chatId, "reply.askHello");
